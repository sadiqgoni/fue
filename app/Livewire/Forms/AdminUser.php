...
//       $userObj->password=bcrypt(123456);
   ...
   {
       $this->alert('warning','Do you want to reset user password to (123456)?',[
   ...
   public function delete($id)
   {
       ...
       $this->alert('question','Do you really want to delete this Staff',[
           'showConfirmButton'=>true,
           'showCancelButton'=>true,
...
//            'timerProgressBar'=>true,
   ...
   public function confirmDelete()
   {
       ...
       $user->delete();
       $this->alert('success','Staff has been deleted Successfully');
   }
   public function active_deactivate($id)
   {
       $user=User::find($id);
       if ($user->status==1){
           $status="deativated";
       ...
       $this->alert('success',"$user->name has been $status  Successfully");
