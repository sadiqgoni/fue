...
//        }
        ...
        if (
            ...
            $old_gross_pay = 0;
            $old_salary_record = \App\Models\SalaryUpdate::where('employee_id', $profileObj->id)->first();
            ...
            if ($this->arrears_months > 0) {
                $new_salary_record = \App\Models\SalaryUpdate::where('employee_id', $profileObj->id)->first();
