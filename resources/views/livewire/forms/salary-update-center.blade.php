                ...
                <form class="p-0" wire:submit.prevent="confirm({{$salary->id}})">
                    <fieldset>
                        ...
                        <div class="my-2 flex space-x-2">
                            <button type="button" style="padding: 3px 5px" wire:click.prevent="setTab(1)"
                                class="{{ $tabs == 1 ? 'font-bold' : '' }} {{ $tabs == 1 ? 'btn-primary text-white' : 'bg-gray-200 text-gray-800' }}">Allowances</button>
                            <button type="button" style="padding: 3px 5px" wire:click.prevent="setTab(2)"
                                class="{{ $tabs == 2 ? 'font-bold' : '' }} {{ $tabs == 2 ? 'btn-primary text-white' : 'bg-gray-200 text-gray-800' }}">Deductions</button>
                            <button type="button" style="padding: 3px 5px" wire:click.prevent="setTab(3)"
                                class="{{ $tabs == 3 ? 'font-bold' : '' }} {{ $tabs == 3 ? 'btn-primary text-white' : 'bg-gray-200 text-gray-800' }}">More
                                Deductions</button>
                            <button type="button" style="padding: 3px 5px" wire:click.prevent="setTab(4)"
                                class="{{ $tabs == 4 ? 'font-bold' : '' }} {{ $tabs == 4 ? 'btn-primary text-white' : 'bg-gray-200 text-gray-800' }}">More
                                Deductions</button>
                        </div>
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6 col-lg-6">
                                        ...
                                        @enderror
                                        <div class="input-group form-group">
                                            <div class="input-group-prepend"><span class="input-group-text">Percentage
                                                    to Pay</span></div>
                                                ...
                                                @forelse($deduct->take(12) as $deduction)
                                                    ...
                                                    <div class="col-12 col-md-4 col-lg-3 ">
                                                        ...
                                                        <div class="input-group form-group">
                                                            ...
                                                            <input type="text" wire:model.lazy="fields.{{ $field }}"
