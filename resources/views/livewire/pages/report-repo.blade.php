...
{{--                              {{$payroll->report_name?? "N/A"}}--}}
                              @if($payroll)
                                  <a href="{{route('report.download',$payroll->id)}}" target="_blank">
...
{{--                              {{$payslip->report_name?? "N/A"}}--}}
                              @if($payslip)
                                  <a href="{{route('report.download',$payslip->id)}}" target="_blank">
                                      <img src="{{url('assets/img/pdf.png')}}" alt="" style="width: 20%">  <i class="fa fa-download"></i></a>
...
{{--                              {{$bank_payment->report_name?? "N/A"}}--}}
                              @if($bank_payment)
                                  <a href="{{route('report.download',$bank_payment->id)}}" target="_blank">
                                      <img src="{{url('assets/img/pdf.png')}}" alt="" style="width: 20%">  <i class="fa fa-download"></i></a>
...
{{--                              {{$bankSummary->report_name?? "N/A"}}--}}
                              @if($bankSummary)
                                  <a href="{{route('report.download',$bankSummary->id)}}" target="_blank">
                                      <img src="{{url('assets/img/pdf.png')}}" alt="" style="width: 20%">  <i class="fa fa-download"></i></a>
...
{{--                              {{$deduction->report_name?? "N/A"}}--}}
                              @if($deduction)
                                  <a href="{{route('report.download',$deduction->id)}}" target="_blank">
                                      <img src="{{url('assets/img/pdf.png')}}" alt="" style="width: 20%">  <i class="fa fa-download"></i></a>
...
{{--                              {{$journal->report_name?? "N/A"}}--}}
                              @if($journal)
                                  <a href="{{route('report.download',$journal->id)}}" target="_blank">
                                      <img src="{{url('assets/img/pdf.png')}}" alt="" style="width: 20%">  <i class="fa fa-download"></i></a>
...
{{--                              {{$pfa->report_name?? "N/A"}}--}}
                              @if($pfa)
                                  <a href="{{route('report.download',$pfa->id)}}" target="_blank">
                                      <img src="{{url('assets/img/pdf.png')}}" alt="" style="width: 20%">  <i class="fa fa-download"></i></a>
                          ...
                          <td>
                              ...
                              @if($nhis)
                                  <a href="{{route('report.download',$nhis->id)}}" target="_blank">
                                      <img src="{{url('assets/img/pdf.png')}}" alt="" style="width: 20%">  <i class="fa fa-download"></i></a>
                          ...
                          <td>
                              {{--                              {{$pfa->report_name?? "N/A"}}--}}
                              @if($pension)
                                  <a href="{{route('report.download',$pension->id)}}" target="_blank">
                                      <img src="{{url('assets/img/pdf.png')}}" alt="" style="width: 20%">  <i class="fa fa-download"></i></a>
