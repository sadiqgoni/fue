            ...
            <form action="{{route('payroll_report')}}" method="post" id="myForm" target="_blank">@csrf
                <div class="row">
                    <div class="col-12 col-md-6">
                        ...
                        <div class="input-group  form-group">
                            <div class="input-group-prepend"><span class="input-group-text">Report Date From</span>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-3">
                            <div class="input-group form-group">
                                ...
                                <select class="form-control" wire:model.live="report_type" wire:change="change"
                                    name="report_type">
                        ...
                        @if($show_group_by == false && $individ == true)
                            ...
                            <div class="col-12 col-lg-3">
                                <div class="input-group form-group">
                                    ...
                                    <select class="form-control" wire:select.prevent="updatedGroupBy"
                                        wire:model.blur="group_by" type="text" name="group_by">
                                        {{-- <option value="">Group By</option>--}}
                                        ...
                                        @if($report_type == 4)
                                            ...
                                            @endforeach
                                        @endif
                                        @if($report_type == 8 || $report_type == 10)
                ...
                <div class="row table-bordered mt-3 ">
                    <div class="col text-center">
                        <button wire:loading.attr="disabled" class="btn generate"
                            wire:click.prevent="generate({{$report_type}})" type="button">Generate</button>
