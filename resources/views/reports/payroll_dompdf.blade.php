...
<body>
    ...
    <img src="{{public_path('storage/' . app_settings()->logo)}}" alt=""
        style="width: 50px;position: absolute;left: 80px">
        ...
        @forelse($payrolls as $key => $payroll)
            ...
            <thead>
                <tr style="border:0 !important">
                    <td colspan="{{ 8 + $active_allowances->count() + $active_deductions->count() }}"
            ...
            @forelse($reports as $index => $report)
                ...
                <tbody>
                    <tr>
                        ...
                        <td>{{$report->account_number}}<br /> {{number_format($report->net_pay, 2)}} <br>{{$report->bank_code}}
                        </td>
