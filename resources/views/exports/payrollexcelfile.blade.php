<table>
    <tr></tr>
    <tr>
        <th colspan="20" style="padding: 0;margin: 0;text-align: center;text-transform: uppercase">
            {{app_settings()->name}}</th>
    </tr>
    <tr>
        <th colspan="20" style="padding: 0;margin: 0;text-align: center">{{address()}}</th>
    </tr>
    ...
    @endphp
    <tr>
        <th colspan="20">Payroll Sheet for All Staff – @if($payrolls->count() > 0)
        {{$payroll_date[0]['salary_month']}}, {{$payroll_date[0]['salary_year']}}@endif
        </th>
    </tr>
</table>
<table class="n-bordered border-none"
    style="width:100% !important;font-size: 12px;border-collapse: collapse;margin-bottom: -20px !important;" border="1">
    ...
    @forelse($payrolls as $key => $payroll)
        ...
        {{-- <tr style="border:0 !important">--}}
            {{-- <td colspan="21" style="padding: 0;border:0 !important;text-align: left;text-transform: capitalize">
                <h3 style="font-size: 24px;margin:20px 0 0 0 !important;">--}}
...
{{--<table>--}}
    {{-- <tr>--}}
        {{-- <th colspan="10" style="padding: 0;margin: 0;text-align: center;text-transform: uppercase">
            {{app_settings()->name}}</th>
    </tr>--}}
    {{-- <tr>
        <th colspan="10" style="padding: 0;margin: 0;text-align: center">{{address()}}</th>
    </tr>--}}
    {{-- <tr>
        <th colspan="10">Payroll Sheet for Staff – @if(isset($payroll_date)){{$payroll_date[0]['salary_month']}},
            {{$payroll_date[0]['salary_year']}}@endif</th>
    </tr>--}}
    {{-- <tr>
        <th colspan="10">SUMMARY FOR PAYROLL ENTRIES</th>
    </tr>--}}
